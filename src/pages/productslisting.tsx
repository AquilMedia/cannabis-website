...
const Productslisting: React.FC = () => {
    return (
        <div>
            <div className="inner_sec_banner position-relative" style={{ backgroundImage: "url('/assets/images/listing-banner.jpg')" }}>
            			...
            			<div className="col-lg-12">
            				<div className="topFilter mb__25">
            					<ul className="list-inline d-flex justify-content-between mb-0">
            						<li className="list-inline-item"> <a href="" className="filter-link"> <i className="cb-icon cb-filter"></i> All Products </a> </li>
            						<li className="list-inline-item active"> <a href="" className="filter-link"> <i className="cb-icon cb-leaf"></i> Cannabis Flowerss </a> </li>
            						<li className="list-inline-item"> <a href="" className="filter-link"> <i className="cb-icon cb-oil"></i> Oil </a> </li>
            						<li className="list-inline-item"> <a href="" className="filter-link"> <i className="cb-icon cb-capsule"></i> Capsule </a> </li>
            						<li className="list-inline-item"> <a href="" className="filter-link"> <i className="cb-icon cb-drop"></i> Drops </a> </li>
            					</ul>
            				</div>
            			</div>
            		</div>
	            						...
	            						<div className="cart_sec">
	            							<div className="d-flex justify-content-between gap-2 align-items-center">
	            								<div className="addtoCart_sec">
	            									<a href="" className="addtocart_btn f-w-M"> View Details </a>
	            								</div>
	            								<div className="cart-icon">
	            									<a href="" className="cartBtn clr-black"> <i className="cb-icon cb-cart"></i> </a>
	            								</div>
	            							</div>
	            						</div>
	            					</div>
